...
TEST(ECS, CheckTransformMovement)
{
    ...
    indie::Vector pos = coordinator.getComponent<ecs::component::Attributes>(tEntity).position;
    EXPECT_EQ(pos.x, 0);
    EXPECT_EQ(pos.y, 0);
    EXPECT_EQ(pos.z, 0);
    ...
    indie::Vector newPos = coordinator.getComponent<ecs::component::Attributes>(tEntity).position;
...
TEST(ECS, CheckTransformRotationAxisAndAngle)
{
    ...
    indie::Vector axis = coordinator.getComponent<ecs::component::Attributes>(tEntity).rotationAxis;
    ...
    indie::Vector newAxis = coordinator.getComponent<ecs::component::Attributes>(tEntity).rotationAxis;
