...
class PointDisplayer {
   public:
     ...
     */
    static void addPoint(indie::Vector point, float range = 100, Color color = YELLOW) noexcept;
    /*
   ...
   private:
    ...
    static bool enabled;
    static std::unordered_map<indie::Vector, Point, indie::VectorHash> points;
};
