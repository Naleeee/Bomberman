...
#include "MapLoader/PartType.hpp"
#include "Vector.hpp"
...
class MapReader {
   public:
    ...
    MapReader(std::string_view filePath, const Vector& maximumMapSize);
     ...
     */
    const Vector& getBlockSize() const noexcept;
    /*
   ...
   private:
     ...
     */
    static Vector getSize(std::string modelPath) noexcept;
    /*
     ...
     */
    static float getXDifference(Vector size1, Vector size2) noexcept;
    /*
     ...
     * size2 -> The size of the second object
     */
    static float getZDifference(Vector size1, Vector size2) noexcept;
    /*
     ...
     * size2 -> The size of the second object
     */
    static float getHighestDifference(Vector size1, Vector size2) noexcept;
    /*
     ...
     */
    bool checkMapValidity(Vector maximumMapSize) const;
    /*
     * Read the map file
     *
     * No return value
