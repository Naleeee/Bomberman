...
class APlayer {
   public:
    ...
    APlayer(ecs::Coordinator& coordinator, const PlayersInfos& playersInfos, std::string_view texturePath, const Vector& position, const PlayerId& id, const PlayerType& type) noexcept;
     ...
     */
    bool tryPutBomb(Map& map, Vector position) noexcept;
    /*
