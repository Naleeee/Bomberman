...
class KeyBoardPlayer final : public APlayer {
   public:
    ...
    KeyBoardPlayer(ecs::Coordinator& coordinator, const PlayersInfos& playersInfos, std::string_view texturePath, const Vector& position, const PlayerId& id, const PlayerKeys& playerKeys, Map& map) noexcept;
