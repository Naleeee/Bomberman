...
class RenderableRelief3d {
   public:
    ...
    explicit RenderableRelief3d(std::string_view reliefPath, indie::Vector size, Color color) noexcept;
     ...
     */
    void setRelief(std::string_view reliefPath, indie::Vector size, Color color) noexcept;
