...
class RenderableCubicMap3d {
   public:
    ...
    RenderableCubicMap3d(std::string_view mapPath, std::string_view atlasPath, indie::Vector size = {1, 1, 1}) noexcept;
     ...
     */
    void setMap(std::string_view mapPath, indie::Vector size);
    /*
