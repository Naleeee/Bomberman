...
class Renderer {
   public:
    ...
    explicit Renderer(ecs::Coordinator& coordinator, CameraMode mode = CAMERA_CUSTOM, indie::Vector position = {10, 10, 10}, indie::Vector looking = {0, 0, 0});
     ...
     */
    void setCameraPosition(indie::Vector position) noexcept;
    /*
     ...
     */
    void setCameraLooking(indie::Vector looking) noexcept;
    /*
     * Set the camera mode
     *
     * No return value
     ...
     */
    indie::Vector getCameraPosition() const noexcept;
    /*
     * Get the actual camera movement
     *
     * Return a reference to the actual camera movement
     */
    indie::Vector& getCameraMovement() const noexcept;
    /*
