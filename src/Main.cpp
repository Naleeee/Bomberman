...
int main(int ac, const char* av[])
{
    ...
    try {
        ...
        graphic::ScenesManager sceneManager(renderer, room, collisionSystem, coordinator);
        sceneManager.setScene<graphic::CreditsScene>(coordinator);
        utils::initEventsListeners(coordinator, renderer, window);
        indie::SettingsManager::init(coordinator);
        indie::Clock clock;
