...
indie::Box::Box(ecs::Coordinator& coordinator, ecs::system::CollisionSystem& collisionSystem, std::string_view modelPath, std::string_view texturePath, const Vector& position) :
...
indie::Box::Box(Box&& other) noexcept :
...
indie::Vector indie::Box::getPosition() const noexcept
{
