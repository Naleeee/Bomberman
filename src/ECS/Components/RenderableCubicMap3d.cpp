...
ecs::component::RenderableCubicMap3d::RenderableCubicMap3d(std::string_view mapPath, std::string_view atlasPath, indie::Vector size) noexcept
{
    this->valid = true;
...
void ecs::component::RenderableCubicMap3d::setMap(std::string_view mapPath, indie::Vector size)
{
    if (not this->valid) {
        throw ecs::error::ComponentError("Renderable Cubicmap 3d", "Use of the object before a correct initialization");
    }
