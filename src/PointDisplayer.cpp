...
// NOLINTNEXTLINE
std::unordered_map<indie::Vector, graphic::PointDisplayer::Point, indie::VectorHash> graphic::PointDisplayer::points = {};
...
void graphic::PointDisplayer::addPoint(indie::Vector point, float range, Color color) noexcept
{
