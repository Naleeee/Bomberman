...
graphic::Renderer::Renderer(ecs::Coordinator& coordinator, CameraMode mode, indie::Vector cameraPosition, indie::Vector cameraLooking) :
...
void graphic::Renderer::setCameraPosition(indie::Vector position) noexcept
{
...
void graphic::Renderer::setCameraLooking(indie::Vector looking) noexcept
{
    auto& camera = coordinator.getComponent<ecs::component::Camera>(this->camera);
...
indie::Vector graphic::Renderer::getCameraPosition() const noexcept
{
...
indie::Vector& graphic::Renderer::getCameraMovement() const noexcept
{
