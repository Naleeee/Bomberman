...
graphic::IntroScene::IntroScene(ecs::Coordinator& coordinator) :
...
graphic::IntroScene::~IntroScene() noexcept
{
...
void graphic::IntroScene::update(graphic::ScenesManager& scenesManager, float /*dt*/)
{
...
indie::Vector graphic::IntroScene::getCameraPosition() const noexcept
{
    return indie::Vector{-300, 150, 300};
}

indie::Vector graphic::IntroScene::getCameraLooking() const noexcept
{
    return indie::Vector{101, 100, -100};
}
