...
graphic::SettingsScene::SettingsScene(ecs::Coordinator& coordinator) :
    coordinator(coordinator), title(coordinator.createEntity()), fpsValue(indie::SettingsManager::getFps()), fps(coordinator.createEntity()), fpsLabel(coordinator.createEntity()), fpsLeftArrow(coordinator.createEntity()), fpsRightArrow(coordinator.createEntity()), monitorValue(indie::SettingsManager::getMonitor()), monitor(coordinator.createEntity()), monitorLabel(coordinator.createEntity()), monitorLeftArrow(coordinator.createEntity()), monitorRightArrow(coordinator.createEntity()), audio(coordinator.createEntity()), audioLabel(coordinator.createEntity()), audioLeftArrow(coordinator.createEntity()), audioRightArrow(coordinator.createEntity()), fullscreen(coordinator.createEntity()), fullscreenLabel(coordinator.createEntity()), fullscreenLeftArrow(coordinator.createEntity()), fullscreenRightArrow(coordinator.createEntity()), returnButton(coordinator.createEntity()), applyButton(coordinator.createEntity()), defaultButton(coordinator.createEntity()), focus(0), maxFields(0)
{
    ...
    coordinator.setComponent(this->fpsLabel, ecs::component::RenderableText2d{.text = std::to_string(indie::SettingsManager::getFps()), .fontSize = 90, .color = WHITE});
    ...
    coordinator.setComponent(this->monitorLabel, ecs::component::RenderableText2d{.text = std::to_string(indie::SettingsManager::getMonitor() + 1), .fontSize = 90, .color = WHITE});
    ...
    coordinator.setComponent(this->audioLabel, ecs::component::RenderableText2d{.text = (indie::SettingsManager::getAudioState() ? "ON" : "OFF"), .fontSize = 90, .color = WHITE});
    ...
    coordinator.setComponent(this->fullscreenLabel, ecs::component::RenderableText2d{.text = (indie::SettingsManager::getFullscreenState() ? "ON" : "OFF"), .fontSize = 90, .color = WHITE});
...
graphic::SettingsScene::~SettingsScene() noexcept
{
...
bool graphic::SettingsScene::changeFps(int fps) noexcept
{
    if (fps < 1) {
        return false;
    }
...
void graphic::SettingsScene::applyFps() noexcept
{
    indie::SettingsManager::setFps(this->fpsValue);
    this->changeFps(indie::SettingsManager::getFps());
}

bool graphic::SettingsScene::changeMonitor(int monitorId) noexcept
{
    if (monitorId < 0) {
        return false;
    }
...
void graphic::SettingsScene::applyMonitor() noexcept
{
    indie::SettingsManager::setMonitor(this->monitorValue);
    this->changeMonitor(indie::SettingsManager::getMonitor());
}

void graphic::SettingsScene::changeAudio(bool state) noexcept
{
...
void graphic::SettingsScene::applyAudio() noexcept
{
    indie::SettingsManager::setAudioState(this->audioValue);
    this->changeAudio(indie::SettingsManager::getAudioState());
}

void graphic::SettingsScene::changeFullscreen(bool state) noexcept
{
...
void graphic::SettingsScene::applyFullscreen() noexcept
{
    indie::SettingsManager::setFullscreenState(this->fullscreenValue);
    this->changeFullscreen(indie::SettingsManager::getFullscreenState());
}

void graphic::SettingsScene::update(graphic::ScenesManager& scenesManager, float /*dt*/)
{
...
indie::Vector graphic::SettingsScene::getCameraPosition() const noexcept
{
    return indie::Vector{-15, 20, 10};
}

indie::Vector graphic::SettingsScene::getCameraLooking() const noexcept
{
    return indie::Vector{-40, 20, 11};
}
