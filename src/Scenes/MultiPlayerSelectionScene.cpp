...
graphic::MultiPlayerSelectionScene::~MultiPlayerSelectionScene() noexcept
{
...
void graphic::MultiPlayerSelectionScene::update(graphic::ScenesManager& scenesManager, float /*dt*/)
{
    if (IsKeyPressed(KEY_A)) {
        if (this->selectedTexture1 > 0) {
            ...
            indie::PlayersManager::setPlayerTexture(1, this->textures.at(this->selectedTexture1));
    ...
    if (IsKeyPressed(KEY_LEFT)) {
        if (this->selectedTexture2 > 0) {
            ...
            indie::PlayersManager::setPlayerTexture(2, this->textures.at(this->selectedTexture2));
    ...
    if (IsKeyPressed(KEY_ENTER)) {
        ...
        indie::PlayersManager::setPlayerTexture(1, this->textures.at(this->selectedTexture1));
        indie::PlayersManager::setPlayerTexture(2, this->textures.at(this->selectedTexture2));
        scenesManager.setScene<graphic::GameScene, true, true, true>(this->coordinator, this->mapReader);
    }
}

indie::Vector graphic::MultiPlayerSelectionScene::getCameraPosition() const noexcept
{
    return indie::Vector{-30, 5, 30};
}

indie::Vector graphic::MultiPlayerSelectionScene::getCameraLooking() const noexcept
{
